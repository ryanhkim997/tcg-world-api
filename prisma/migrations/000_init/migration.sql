...
-- CreateEnum
CREATE TYPE "timezone_enum_1137e051" AS ENUM ('PST');

-- CreateEnum
CREATE TYPE "payment_provider_enum_1022488b" AS ENUM ('card');
...
-- CreateTable
CREATE TABLE "cards_price_history" (
...
-- CreateTable
CREATE TABLE "packs_price_history" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
...
-- CreateIndex
CREATE UNIQUE INDEX "cards_price_charting_id_key" ON "cards"("price_charting_id");

-- AddForeignKey
ALTER TABLE "pull_history" ADD CONSTRAINT "pull_history_card_pack_id_fkey" FOREIGN KEY ("card_pack_id") REFERENCES "pack_cards"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "pull_history" ADD CONSTRAINT "pull_history_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_card" ADD CONSTRAINT "user_card_card_id_fkey" FOREIGN KEY ("card_id") REFERENCES "cards"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_card" ADD CONSTRAINT "user_card_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "user_policy_agreement" ADD CONSTRAINT "user_policy_agreement_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "cards_price_history" ADD CONSTRAINT "card_price_history_card_id_fkey" FOREIGN KEY ("card_id") REFERENCES "cards"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "deposits" ADD CONSTRAINT "deposit_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "email_notifications" ADD CONSTRAINT "email_notification_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "pack_cards" ADD CONSTRAINT "card_pack_card_id_fkey" FOREIGN KEY ("card_id") REFERENCES "cards"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "pack_cards" ADD CONSTRAINT "card_pack_pack_id_fkey" FOREIGN KEY ("pack_id") REFERENCES "packs"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "packs_price_history" ADD CONSTRAINT "pack_price_history_pack_id_fkey" FOREIGN KEY ("pack_id") REFERENCES "packs"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "tickets" ADD CONSTRAINT "ticket_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "withdrawals" ADD CONSTRAINT "fk_withdrawal_user" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "withdrawals" ADD CONSTRAINT "withdrawal_shipping_address_fkey" FOREIGN KEY ("shipping_address") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
